...
public class manage_addStaff_control implements Initializable{


    @FXML
    private TextField name,password,phone,birth;
	...
	public void submitAction(ActionEvent e) { //등록버튼 눌렀을 경우
		elart.setText(""); //초기값
